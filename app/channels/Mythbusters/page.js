...
import mythbustersLogo from '../../../public/mythbusters.jpeg'; 

export default function MythbustersPlayer() {
  const router = useRouter();
  const videoRef = useRef(null);
  
  // Media Data for Mythbusters
  const media = {
    Title: "Mythbusters",
    Year: "LIVE",
    Genre: "Science, Documentary, Entertainment",
    Plot: "Adam Savage and Jamie Hyneman use modern-day science to put urban legends to the test. They don't just tell the myths, they put them to the test to see if they are Busted, Plausible, or Confirmed.",
    Language: "English",
    Country: "United Kingdom",
    Quality: "1080p"
  };

  const streamUrl = "https://amg00627-amg00627c14-rakuten-uk-4802.playouts.now.amagi.tv/index.m3u8";
  const imgSrc = mythbustersLogo;
        ...
        <div className="relative group">
          ...
          <div className="relative bg-black rounded-2xl overflow-hidden shadow-2xl border border-stone-800 aspect-video lg:h-[70vh] mx-auto">
            <video
              ...
              poster={imgSrc.src} // Uses the imported image as the poster
              autoPlay
              muted 
            />
          </div>
